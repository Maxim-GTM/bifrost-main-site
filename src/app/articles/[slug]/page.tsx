...
import { getAllArticleSlugs, getArticleBySlug } from '../../../lib/ghostArticles'
import '../blog.css'
...
export async function generateMetadata({ params }: BlogPostPageProps): Promise<Metadata> {
  ...
  if (!post) {
    return {
      title: 'Article Not Found | Bifrost Articles'
    }
  }

  return {
    title: `${post.title} | Bifrost Articles`,
        ...
        <div className="lg:flex lg:gap-8">
          ...
          <main className="flex-1 min-w-0">
            <article className="max-w-3xl">
              <PostHeader post={post} type="articles" />
