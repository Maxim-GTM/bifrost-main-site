...
export const metadata: Metadata = {
  ...
  description:
    'High-performance AI gateway that connects multiple AI providers through a single API. Get 100% uptime with automatic failover and load balancing.',
  ...
  openGraph: {
    ...
    description:
      'High-performance AI gateway that connects multiple AI providers through a single API.',
    locale: 'en_US',
    type: 'website',
  },
  twitter: {
