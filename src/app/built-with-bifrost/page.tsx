        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="text-center relative z-10">
            ...
            <div className="flex justify-center gap-4">
              <PrimaryButton href={`${basePath}/submit`} className="px-6 py-3 text-sm uppercase tracking-wide">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 mb-20">
        ...
        {projects.length > 0 ? (
          ...
          <div className="text-center py-20 bg-gray-50 rounded-2xl border border-dashed border-gray-200">
            ...
            <Link href={`${basePath}/submit`} className="text-[var(--accent-text-dark)] hover:underline text-sm font-medium uppercase tracking-wide">
