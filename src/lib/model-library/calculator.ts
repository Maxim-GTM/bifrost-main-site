...
export function calculateCost(modelData: ModelData, input: CalculationInput): CalculationResult {
  ...
  if (mode === 'audio_transcription') {
    ...
    const hasTokenPricing = !!modelData.input_cost_per_token || !!modelData.output_cost_per_token
