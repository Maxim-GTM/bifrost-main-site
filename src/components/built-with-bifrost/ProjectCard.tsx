...
export default function ProjectCard({ project }: ProjectCardProps) {
    ...
    return (
        <Link href={`${basePath}/project/${project.slug}`} className="group block bg-white rounded-xl overflow-hidden border border-gray-100 hover:border-[var(--accent-border)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all duration-300">
            {/* Image Container */}
