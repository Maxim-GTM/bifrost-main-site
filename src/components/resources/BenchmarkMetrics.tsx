                    ...
                    return (
                        <div key={metric.name} className="p-4">
                            ...
                            <div className="flex items-center justify-between mb-3">
                                ...
                                {bifrostWins && (
                                    <span className="text-xs font-mono font-semibold text-[var(--accent-text)] bg-[var(--accent)]/10 px-2 py-1">
                            ...
                            <div className="space-y-2">
                                ...
                                {(() => {
                                    const bifrostBarWidth = metric.lowerIsBetter
                                        ...
                                        : Math.min(100, (metric.bifrost / Math.max(metric.bifrost, metric.litellm)) * 100);
                                    const isNarrow = bifrostBarWidth < 15;

                                    return (
                                        <div className="flex items-center gap-3">
                                            <span className="text-xs font-mono text-gray-500 w-16">Bifrost</span>
                                ...
                                {(() => {
                                    const litellmBarWidth = metric.lowerIsBetter
                                        ? 100
                                        : Math.min(100, (metric.litellm / Math.max(metric.bifrost, metric.litellm)) * 100);
                                    const isNarrow = litellmBarWidth < 15;

                                    return (
                                        <div className="flex items-center gap-3">
                                            <span className="text-xs font-mono text-gray-500 w-16">LiteLLM</span>
                                            <div className="flex-1 h-6 bg-gray-100 relative">
                                                <div
