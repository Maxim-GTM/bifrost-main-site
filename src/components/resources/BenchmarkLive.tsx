...
export default function BenchmarkLive() {
    ...
    const generateAreaPath = (getValue: (d: DataPoint) => number, maxValue: number, height: number) => {
        if (dataPoints.length < 2) return '';
        ...
        <div className="border border-gray-200 bg-white">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 p-4 border-b border-gray-200">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2">
                        <span className="text-xs text-gray-500 font-mono">RPS:</span>
                        {rpsOptions.map(rps => (
                            <button
                                key={rps}
                    ...
                    >
                        {isRunning ? <Pause className="w-4 h-4 text-gray-600" /> : <Play className="w-4 h-4 text-gray-600" />}
                    </button>

                    <button onClick={handleReset} className="p-2 hover:bg-gray-100 transition-colors">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="p-4 border-b lg:border-b-0 lg:border-r border-gray-200">
                    <div className="flex items-baseline justify-between mb-3">
                        <span className="text-sm text-gray-600 font-mono">
                            avg latency: <span className="text-[#35c09e] font-semibold">{formatLatency(currentBifrost)}</span>
                        </span>
                        <div className="flex items-center gap-1.5">
                            <div className="w-2 h-2 rounded-full bg-[#35c09e]" />
                            <span className="text-xs font-medium text-gray-900">Bifrost</span>
                        </div>
                    </div>
                    <div className="flex">
                        {/* Y-axis labels - 0-10s scale */}
                        <div className="flex flex-col justify-between text-[9px] text-gray-400 font-mono pr-2 h-[100px]">
                            <span>10s</span>
                            <span>5s</span>
                            <span>2s</span>
                            <span>0</span>
                        </div>
                        <div ref={chartRef} className="relative h-[100px] flex-1 border border-gray-100 rounded bg-white overflow-hidden">
                ...
                <div className="p-4">
                    <div className="flex items-baseline justify-between mb-3">
                        <span className="text-sm text-gray-600 font-mono">
                            avg latency: <span className="text-red-500 font-semibold">{formatLatency(currentLitellm)}</span>
                        </span>
                        <div className="flex items-center gap-1.5">
                    ...
                    <div className="flex">
                        ...
                        <div className="relative h-[100px] flex-1 border border-gray-100 rounded bg-white overflow-hidden">
                            <svg width={chartWidth} height={chartHeight} className="absolute inset-0">
                                {/* Area fill */}
                                {dataPoints.length > 1 && (
                                    <path
            ...
            {/* Live Metrics */}
            <div className="grid grid-cols-2 lg:grid-cols-6 border-t border-gray-200">
                <div className="p-3 border-r border-b lg:border-b-0 border-gray-200 bg-[#35c09e]/5">
                    <div className="text-[10px] text-gray-500 font-mono uppercase mb-0.5">Bifrost P50</div>
                    <div className="text-lg font-mono font-semibold text-[#35c09e] tabular-nums">
                        {formatLatency(metrics.bifrostLatency)}
                    </div>
                </div>
                <div className="p-3 border-r border-b lg:border-b-0 border-gray-200 bg-[#35c09e]/5">
                    <div className="text-[10px] text-gray-500 font-mono uppercase mb-0.5">Bifrost RPS</div>
                    <div className="text-lg font-mono font-semibold text-[#35c09e] tabular-nums">
                        {metrics.bifrostRps}
                    </div>
                </div>
                <div className="p-3 border-r border-b lg:border-b-0 border-gray-200 bg-[#35c09e]/5">
                    <div className="text-[10px] text-gray-500 font-mono uppercase mb-0.5">Bifrost Success</div>
                    <div className="text-lg font-mono font-semibold text-[#35c09e] tabular-nums">
                        {metrics.bifrostSuccess}%
                    </div>
                </div>
                <div className="p-3 border-r border-gray-200 bg-red-50/50">
                    <div className="text-[10px] text-gray-500 font-mono uppercase mb-0.5">LiteLLM P50</div>
                    <div className="text-lg font-mono font-semibold text-red-600 tabular-nums">
                        {formatLatency(metrics.litellmLatency)}
                    </div>
                </div>
                <div className="p-3 border-r border-gray-200 bg-red-50/50">
                    <div className="text-[10px] text-gray-500 font-mono uppercase mb-0.5">LiteLLM RPS</div>
                    <div className="text-lg font-mono font-semibold text-red-600 tabular-nums">
                        {metrics.litellmRps}
                    </div>
                </div>
                <div className="p-3 bg-red-50/50">
                    <div className="text-[10px] text-gray-500 font-mono uppercase mb-0.5">LiteLLM Success</div>
                    <div className="text-lg font-mono font-semibold text-red-600 tabular-nums">
