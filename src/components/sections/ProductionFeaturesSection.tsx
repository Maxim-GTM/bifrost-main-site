    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-gray-50 via-white to-gray-100 py-16">
        <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative mx-auto max-w-3xl xl:w-2xl">
            {/* Main code container */}
            <div className="relative rounded-sm border border-gray-700 bg-gray-900 shadow-2xl">
              {/* Terminal header */}
              <div className="mb-4 flex items-center border-b border-gray-700 py-0">
              ...
              {/* Command line */}
              <div className="flex items-center space-x-3 px-6 pb-5">
                <span className="font-mono text-sm text-green-400">$</span>
                <code className="font-mono text-lg font-medium tracking-wide text-white">
                  npx @maximhq/bifrost
                </code>
                <div className="-ml-2 h-5 w-2 animate-pulse bg-green-400"></div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-500">
              No configuration required • Built in observability • MCP clients • Advanced routing
              rules • Virtual keys
            </p>
          </div>
        </div>
      ...
      <section id="features" className="relative overflow-hidden bg-white py-20 lg:py-32">
        {/* Background Pattern */}
        ...
        <div className="relative z-10 mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto max-w-3xl text-lg text-gray-600 lg:text-xl">
              Everything you need to deploy, monitor, and scale AI applications in production
              environments.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="space-y-8">
              <div className="text-center lg:text-left">
                <h3 className="mb-6 text-2xl font-bold text-gray-900">OSS Features</h3>
              </div>
              ...
              <div className="space-y-6">
                ...
                <FeatureCard
                  plan="oss"
                  icon={<PlugZapIcon className="h-7 w-7" />}
                ...
                <FeatureCard
                  plan="oss"
                  icon={<ReplaceIcon className="h-7 w-7" />}
                ...
                <FeatureCard
                  plan="oss"
                  icon={<TelescopeIcon className="h-7 w-7" />}
            ...
            <div className="space-y-8">
              <div className="text-center lg:text-left">
                <h3 className="mb-6 text-2xl font-bold text-gray-900">Enterprise Features</h3>
              </div>
