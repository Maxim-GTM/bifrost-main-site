            ...
            case 'Enter':
                ...
                if (focusedIndex >= 0 && focusedIndex < searchSuggestions.length) {
                    ...
                    if (suggestion.type === 'model' && suggestion.model) {
                        router.push(`${getCostCalculatorBaseUrl()}/llm-cost-calculator/provider/${encodeURIComponent(suggestion.model.provider)}/model/${suggestion.model.slug}`);
                        setShowSuggestions(false);
                        setFocusedIndex(-1);
                ...
                <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <div className="flex-1 relative">
                        <input
                            ...
                            className="w-full px-4 py-2 text-black border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-base leading-normal box-border"
                        />
                            ...
                            >
                                {searchSuggestions.map((suggestion, index) => (
                                    <button
                                        ...
                                        className={`w-full text-left px-4 py-2 hover:bg-green-50 transition-colors ${index === focusedIndex ? 'bg-green-50' : ''
                    ...
                    <table className="w-full divide-y divide-gray-200 lg:table-auto">
                        <thead className="bg-gray-50 border-b border-gray-200">
                            <tr>
                                ...
                                <th
                                    className="px-3 sm:px-4 py-3 sm:py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors min-w-[120px] lg:w-[11%]"
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td className="lg:w-[11%] p-0">
                                            <Link href={modelUrl} className="block w-full h-full px-3 sm:px-4 py-3 sm:py-4">
                                                <span className="px-2 py-1 text-xs font-medium text-green-700 bg-green-50 rounded inline-block break-words max-w-full">
                                        ...
                                        <td className="whitespace-nowrap lg:w-[11%] p-0">
                                            <Link href={modelUrl} className="block w-full h-full px-3 sm:px-4 py-3 sm:py-4">
                                                {inputCostPer1M !== null ? (
                                        ...
                                        <td className="min-w-[140px] sm:min-w-[160px] lg:w-[19%] p-0">
                                            <Link href={modelUrl} className="block w-full h-full px-3 sm:px-4 pr-4 py-3 sm:py-4">
                        ...
                        <button
                            ...
                            className={
                                currentClientPage === 1
                                    ...
                                    : 'inline-flex items-center justify-center h-10 px-3 rounded-lg bg-white border border-gray-200 text-sm text-gray-700 hover:bg-green-50 hover:border-green-200 transition-colors'
                            }
                        >
                            Prev
                        </button>
