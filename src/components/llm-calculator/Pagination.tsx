...
export default function Pagination({
    ...
    const PageLink = ({
        ...
        <Link
            ...
            className={
                isCurrent
                    ? 'inline-flex items-center justify-center min-w-[40px] h-10 px-3 rounded-lg bg-green-500 text-white border border-green-500 text-sm font-medium'
                    : 'inline-flex items-center justify-center min-w-[40px] h-10 px-3 rounded-lg bg-white border border-gray-200 text-sm font-medium text-gray-700 hover:bg-green-50 hover:border-green-200 transition-colors'
            }
        >
            {label ?? String(p)}
        </Link>
