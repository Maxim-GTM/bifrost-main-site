...
export default function Pagination({
  ...
  const PageLink = ({
    ...
    <Link
      ...
      className={
        isCurrent
          ? 'inline-flex h-10 min-w-[40px] items-center justify-center rounded-lg border border-green-500 bg-green-500 px-3 text-sm font-medium text-white'
          : 'inline-flex h-10 min-w-[40px] items-center justify-center rounded-lg border border-gray-200 bg-white px-3 text-sm font-medium text-gray-700 transition-colors hover:border-green-200 hover:bg-green-50'
      }
    >
      {label ?? String(p)}
    </Link>
