(function () {
    ...
    function injectStyles() {
      ...
      s.textContent = [
        ...
        '.bfr-dl-panel{position:absolute !important;bottom:0 !important;right:0 !important;width:' + PANEL_W + ' !important;background:#fff !important;border:1px solid #e2e5e9 !important;border-radius:12px !important;box-shadow:0 8px 32px rgba(0,0,0,.12),0 2px 8px rgba(0,0,0,.06) !important;overflow:hidden !important;opacity:0;transform:translateY(12px) scale(.98);transition:opacity .3s ease,transform .3s ease;pointer-events:none;display:none}',
        ...
        // Corner accents
        '.bfr-dl-corner{position:absolute;width:8px;height:8px;z-index:1}',
        '.bfr-dl-corner-tl{top:3px;left:0;border-top:1px solid #35c09e;border-left:1px solid #35c09e}',
        '.bfr-dl-corner-tr{top:3px;right:0;border-top:1px solid #35c09e;border-right:1px solid #35c09e}',
        '.bfr-dl-corner-bl{bottom:0;left:0;border-bottom:1px solid #35c09e;border-left:1px solid #35c09e}',
        '.bfr-dl-corner-br{bottom:0;right:0;border-bottom:1px solid #35c09e;border-right:1px solid #35c09e}',
        ...
        // Submit
        '.bfr-dl-submit{position:relative !important;width:100% !important;height:40px !important;margin-top:6px !important;font-family:"SF Mono",Monaco,Consolas,monospace !important;font-size:12px !important;font-weight:600 !important;text-transform:uppercase !important;letter-spacing:.06em !important;color:#fff !important;background:#33C09E !important;border:none !important;border-radius:8px !important;cursor:pointer !important;transition:background .15s !important}',
    ...
    function cornersHTML() {
      return (
        '<div class="bfr-dl-corner bfr-dl-corner-tl"></div>' +
        '<div class="bfr-dl-corner bfr-dl-corner-tr"></div>' +
        '<div class="bfr-dl-corner bfr-dl-corner-bl"></div>' +
        '<div class="bfr-dl-corner bfr-dl-corner-br"></div>'
      );
    }
